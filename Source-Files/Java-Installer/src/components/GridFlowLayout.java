...
/*
 * $Id: GridFlowLayout.java,v 1.1 2006/03/20 00:11:56 paujones2005 Exp $ $Name:  $
 *
...
public class GridFlowLayout implements LayoutManager2, Serializable {
	...
	private Hashtable cellSizes = new Hashtable();
	private HashMap componentTable = new HashMap();
	private HashMap constraintsTable = new HashMap();
