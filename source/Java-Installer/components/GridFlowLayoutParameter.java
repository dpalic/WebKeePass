...
/*
 * $Id: GridFlowLayoutParameter.java,v 1.1 2006/03/20 00:11:56 paujones2005 Exp $ $Name:  $
 *
...
public class GridFlowLayoutParameter {
	...
	public GridFlowLayoutParameter(boolean moveToNextRow, int tabToColumn) {
		this.moveToNextRow = moveToNextRow;
		this.tabToColumn = tabToColumn;
		this.fillCell = false;
	}
	public GridFlowLayoutParameter(boolean moveToNextRow, int tabToColumn, boolean fillCell) {
		this.moveToNextRow = moveToNextRow;
		this.tabToColumn = tabToColumn;
