...
public class RandPassApplet extends JApplet {
	...
	private static final long serialVersionUID = 3313153617951010676L;
	private JTextArea display = new JTextArea();
	private JButton clearButton = new JButton("Clear");
	private JButton generateButton = new JButton("Generate");
	private char[] passwordAlphabet = PasswordGntr.DEFAULT_LETTERS_NUMBERS;
	...
	private PasswordGntr randPass = new PasswordGntr(passwordAlphabet);
	...
	public static void main(String[] args) {
		...
		RandPassApplet applet = new RandPassApplet();
