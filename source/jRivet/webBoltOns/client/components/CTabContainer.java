...
/*
 * $Id: CTabContainer.java,v 1.1 2007/04/20 19:37:21 paujones2005 Exp $ $Name:  $
 *
...
public class CTabContainer extends JTabbedPane implements StandardComponentLayout {
	
	private static final long serialVersionUID = -6523355193142223304L;

	public CTabContainer() {}
	...
	public void buildComponent(WindowItem parentItem, WindowItem thisItem, WindowFrame mainFrame) {
		...
		if(thisItem.getOrientation().equals(WindowItem.BOTTOM))
