...
public class CTextRTFField extends CTextHTMLField implements
	...
	private JToolBar buildToolBar() {
		...
		mnu = cnct.buildFancyButton("Import ", "eImport.gif", null, ' ');
		mnu.addActionListener(new ImportAction());
		tb.add(mnu, null);
		tb.add(new JToolBar.Separator());
		
		mnu = cnct.buildFancyButton("Export ", "eExport.gif", null, ' ');
		...
		mnu = cnct.buildFancyButton("Paste  ", "ePaste.gif", null, ' ');
		mnu.addActionListener(mainT.getActionMap().get(DefaultEditorKit.pasteAction));
		tb.add(mnu, null);
		tb.add(new JToolBar.Separator());
		
		mnu = cnct.buildFancyButton("Font ", "eFont.gif", null, ' ');
		mnu.setActionCommand("font");
		mnu.addActionListener(this);
		tb.add(mnu, null);
		tb.add(new JToolBar.Separator());
		
		mnu = cnct.buildFancyButton("Find & Replace ", "eFind.gif", null, ' ');
