...
public class CPasswordEditor extends JPasswordField implements StandardComponentLayout, 
	...
	private final static String LETTERS =  "Upper & lower letters ";
	private final static String LOWERCASE_LETTERS ="Lower letters";
	private final static String LOWERCASE_LETTERS_NUMBERS = "Lower letters & numbers";
	private final static String NUMBERS_LETTERS =  "Upper & lower letters & numbers";
	...
	public void buildComponent(WindowItem parentItem, WindowItem thisItem, WindowFrame mainFrame) {
		...
		shwPW = cnct.buildFancyButton(null, "idots.gif", "show/hide password", 'c' );
		shwPW.setActionCommand(ShowPW);
		shwPW.addActionListener(this);
		fieldPanel.add(shwPW, BorderLayout.CENTER);
		
		genPW = cnct.buildFancyButton(null, "key.gif", "create password", 'c' );
		...
		b = new JRadioButton(NUMBERS_LETTERS);
		...
		b = new JRadioButton(UPPERCASE_LETTERS_NUMBERS);
		...
		b = new JRadioButton(UPPERCASE_LETTERS);
		...
		//len.setPreferredSize(new Dimension(50 , 19));		 
		popup.add(len, BorderLayout.EAST);
		
		crtPW = cnct.buildFancyButton("Create Password", "key.gif", "create password", 'p' );
